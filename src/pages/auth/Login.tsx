...
export default function Login() {
  ...
  return (
    <div className="min-h-dvh flex flex-col justify-end bg-gradient-to-b from-primary/20 to-background px-6 pb-10">
      ...
      <div className="font-display text-[44px] leading-[0.95] tracking-wide text-foreground mb-5">
        SEU RING,
        <br />
        SUA AGENDA.
      </div>
